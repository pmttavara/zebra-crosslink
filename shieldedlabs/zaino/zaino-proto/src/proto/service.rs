        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/cash.z.wallet.sdk.rpc.CompactTxStreamer/SendFiatFinality" => {
                    #[allow(non_camel_case_types)]
                    struct SendFiatFinalitySvc<T: CompactTxStreamer>(pub Arc<T>);
                    impl<
                        T: CompactTxStreamer,
                    > tonic::server::UnaryService<super::BlockId>
                    for SendFiatFinalitySvc<T> {
                        type Response = super::SendResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CompactTxStreamer>::send_fiat_finality(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SendFiatFinalitySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,

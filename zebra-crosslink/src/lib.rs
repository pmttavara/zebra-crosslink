...
async fn tfl_service_main_loop(internal_handle: TFLServiceHandle) -> Result<(), String> {
    ...
    let mut malachite_system = start_malachite(internal_handle.clone(), 1, initial_validator_set.validators, my_private_key, bft_config).await;
...
mod strm {
    ...
    use super::{
        MalPublicKey, MalHeight, MalRound,
        MalStreamedProposal,
    };
    ...
    pub struct StreamState {
        ...
        pub init_info: Option<MalStreamedProposal>,
    ...
    pub struct MalStreamedProposalParts {
        ...
        pub parts: Vec<MalStreamedProposal>,
    }
}
